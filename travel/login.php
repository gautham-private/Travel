...
if (isset($_POST['username'])) {
    ...
    $sql = "SELECT * FROM register WHERE User_Name='" . $uname . "' AND Password='" . $password . "' LIMIT 1";
...
<html lang="en">
   ...
   <body>
      ...
      <div class="blog_section layout_padding margin_top_90">
         <div class="container">
            <h1 class="blog_taital">USER LOGIN</h1>
          ...
          <div 
               <li class="subscribe_bt"><a class="blog_taital" href="group2.html">REGISTER</a><a class="blog_taital" href="login2.php">ADMIN</a></li></div>
